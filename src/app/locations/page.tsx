...
export default function LocationsPage() {
  return (
    <div className="max-w-5xl mx-auto p-8">
      <h1 className="text-4xl font-bold text-teal-900 mb-10">Our Locations</h1>
      {locations.map((location, index) => (
        <section
          key={index}
          className="flex mb-5 flex-col md:flex-row custom-two-column gap-6"
        >
          <AnimatedElement>
            <Card className="p-4">
              <div className="flex flex-col md:flex-row gap-4">
                <div className="md:w-2/3 flex flex-col">
                  ...
                  <Link
                    href={location.linkGoogleMapsReviews}
                  ...
                  <div className="mt-auto pt-5">
                    <Button
                      bookingLink={location.linkBooking}
                      buttonText="Explore Services Here"
                    />
                  </div>
                </div>
