        ...
        <footer className="bg-teal-900 text-gray-200 pt-5 sm:pt-3">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="team-grid">
                    <div className="flex flex-col md:items-start mb-4 sm:mb-2">
                    ...
                    <div className="flex flex-col md:items-start mb-4 sm:mb-2">
                        ...
                        <ul className="space-y-4 md:space-y-0 md:space-x-4 md:flex md:flex-col">
                            <li>
                                <Link href="https://www.instagram.com/laser_byolga_wpg?igsh=Mmc5MjY1MHo0cjJl" className="hover:text-teal-100 transition text-sm">Instagram</Link>
                            </li>
                            <li>
                                <Link href="https://www.facebook.com/share/16Czft5XRS/?mibextid=LQQJ4d" className="hover:text-teal-100 transition text-sm">Facebook</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="flex flex-col md:items-start mb-4 sm:mb-2">
