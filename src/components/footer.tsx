          ...
          <div className="team-grid gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    href="https://www.instagram.com/laser_byolga_wpg?igsh=Mmc5MjY1MHo0cjJl"
                    className="hover:text-teal-100 transition text-sm"
                  >
                    Instagram
                  </Link>
                ...
                <li>
                  <Link
                    href="https://www.facebook.com/share/16Czft5XRS/?mibextid=LQQJ4d"
                    className="hover:text-teal-100 transition text-sm"
                  >
                    Facebook
                  </Link>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="mailto:info@laserandbeauty.com"
                    className="hover:text-teal-100 transition text-sm"
                  >
                    olga.rogozjanskaja@gmail.com
                  </a>
                </li>
                <li>
                  <a
                    href="tel:+1-431-336-3315"
                    className="hover:text-teal-100 transition text-sm"
                  >
                    +1 431-336-3315
                  </a>
